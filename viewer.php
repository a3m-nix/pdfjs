...
<body tabindex="1">
    ...
    <div id="mainContainer">
      ...
      <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
        <div id="secondaryToolbarButtonContainer">
          <button onclick="window.location.href='index.php'" class="secondaryToolbarButton" title="New File" tabindex="51" data-l10n-id="pdfjs-new-file-button">
            <span data-l10n-id="pdfjs-new-file-button-label">New</span>
          </button>
  ...
  <style>
    .floating-button {
      ...
      /* Tambahkan transisi warna latar belakang */
      border: 1px solid transparent;
      /* Hapus border dan gunakan transparan untuk mempertahankan ukuran tombol */
    }
    ...
    .floating-button:hover {
      ...
      background-color: rgb(233,
          229,
          229);
      /* Ubah warna latar belakang menjadi biru lebih gelap saat dihover */
    }

    .floating-button img {
      width: 24px;
      /* Kurangi sedikit ukuran ikon */
      height: 24px;
      /* Kurangi sedikit ukuran ikon */
    }
  ...
  <a href="#" class="floating-button" id="saveButton">
    <img src="save_icon.png" alt="Save" width="30" height="30" />
  </a>
  <!-- Toast notification -->
  ...
  <script type="module">
    ...
    // Accessing pdfDocument
    const pdfViewerApplication = PDFViewerApplication;
    // event ctrl+alt+s
    document.addEventListener("keydown", function(e) {
      if (e.ctrlKey && e.code === "KeyS") {
        e.preventDefault();
        uploadPDFToServer(pdfViewerApplication);
      }
    });
    ...
    // Fungsi untuk mengirim PDF ke server
    async function uploadPDFToServer(pdfViewerApplication, options = {}) {
      ...
      try {
        ...
        // Make AJAX request to upload the PDF data
        const xhr = new XMLHttpRequest();
        xhr.open("POST", "upload.php?want=json");
        xhr.onload = function() {
          if (xhr.status === 200) {
            document.title = pdfViewerApplication._title;
